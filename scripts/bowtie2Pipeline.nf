...
params.fastq    = "/etc/ace-data/CancerGenomicsWG/VariantCalling/samples/SRR*_R{1,2}.fastq.gz"
params.outdir   = "/etc/ace-data/CancerGenomicsWG/users/walter/results"
params.ref      = "/etc/ace-data/CancerGenomicsWG/users/walter/reference/*.fasta"
params.refdir   = "/etc/ace-data/CancerGenomicsWG/users/walter/reference"
